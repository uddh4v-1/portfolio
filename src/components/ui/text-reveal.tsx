...
export const TextReveal: FC<TextRevealProps> = ({ children, className }) => {
  ...
  return (
    <div ref={sectionRef} className={cn("relative z-0 h-[30vh] md:h-[20vh]", className)}>
      <div className="sticky top-0 mx-auto flex h-[50%] max-w-4xl items-center bg-transparent px-6 md:px-4 py-12 md:py-20">
